  ...
  const features = [
    {
      ...
      icon: (
        <img src="/Icon%20home/Premium%20Components.png" alt="Premium Components" className="w-10 h-10 sm:w-12 sm:h-12 object-contain" />
      )
    },
    {
      ...
      icon: (
        <img src="/Icon%20home/Engineered%20as%20One%20System.png" alt="Engineered as One System" className="w-10 h-10 sm:w-12 sm:h-12 object-contain" />
      )
    },
    {
      ...
      icon: (
        <img src="/Icon%20home/Precision%20Manufacturing.png" alt="Precision Manufacturing" className="w-10 h-10 sm:w-12 sm:h-12 object-contain" />
      )
    },
    {
      ...
      icon: (
        <img src="/Icon%20home/Rigorous%20Testing.png" alt="Rigorous Testing" className="w-10 h-10 sm:w-12 sm:h-12 object-contain" />
      )
    }
  ];
