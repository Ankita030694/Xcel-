  ...
  const features = [
    {
      ...
      icon: (
        <img src="/Icon home/Premium Components.svg" alt="Premium Components" className="w-[20px] h-[20px] sm:w-[24px] sm:h-[24px] object-contain" />
      )
    },
    {
      ...
      icon: (
        <img src="/Icon home/Engineered as One System.svg" alt="Engineered as One System" className="w-[20px] h-[20px] sm:w-[24px] sm:h-[24px] object-contain" />
      )
    },
    {
      ...
      icon: (
        <img src="/Icon home/Precision Manufacturing.svg" alt="Precision Manufacturing" className="w-[20px] h-[20px] sm:w-[24px] sm:h-[24px] object-contain" />
      )
    },
    {
      ...
      icon: (
        <img src="/Icon home/Rigorous Testing.svg" alt="Rigorous Testing" className="w-[20px] h-[20px] sm:w-[24px] sm:h-[24px] object-contain" />
      )
    }
  ];
