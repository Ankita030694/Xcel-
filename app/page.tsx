  ...
  const features = [
    {
      ...
      icon: (
        <img src="/Icon%20home/Premium%20Components.svg" alt="Premium Components" className="w-[20px] h-[20px] sm:w-[24px] sm:h-[24px] object-contain" />
      )
    },
    {
      ...
      icon: (
        <img src="/Icon%20home/Engineered%20as%20One%20System.svg" alt="Engineered as One System" className="w-[20px] h-[20px] sm:w-[24px] sm:h-[24px] object-contain" />
      )
    },
    {
      ...
      icon: (
        <img src="/Icon%20home/Precision%20Manufacturing.svg" alt="Precision Manufacturing" className="w-[20px] h-[20px] sm:w-[24px] sm:h-[24px] object-contain" />
      )
    },
    {
      ...
      icon: (
        <img src="/Icon%20home/Rigorous%20Testing.svg" alt="Rigorous Testing" className="w-[20px] h-[20px] sm:w-[24px] sm:h-[24px] object-contain" />
      )
    }
  ];
