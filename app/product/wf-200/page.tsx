      ...
      <main className="flex-1 w-full max-w-[1400px] mx-auto px-4 sm:px-6 lg:px-8 py-6 lg:py-10">
              ...
              {sections.map((section) => (
                ...
                >
                  <div className="flex flex-col lg:flex-row gap-10 lg:gap-16 pt-0 pr-6 sm:pr-10 lg:pr-12 pb-6 sm:pb-10 lg:pb-0 pl-0">
                    ...
                    <div className="relative w-full h-24 mt-6 opacity-[0.04] pointer-events-none -mb-4">
        ...
        <div className="bg-[#0a2766] rounded-2xl sm:rounded-3xl p-6 sm:p-8 flex flex-col md:flex-row items-center justify-between gap-6 sm:gap-8 shadow-xl">
          ...
          <div className="flex flex-col sm:flex-row items-center gap-4 sm:gap-6 w-full md:w-auto mt-2 md:mt-0">
            <a href="tel:+919971025730" className="flex items-center gap-3 text-white font-bold text-[16px] sm:text-[18px] hover:text-blue-200 transition-colors w-full sm:w-auto justify-center">
            ...
            <a href="https://wa.me/919971025730" target="_blank" rel="noopener noreferrer" className="w-full sm:w-auto bg-white text-[#0a2766] py-3.5 px-8 rounded-xl font-bold flex items-center justify-center gap-3 hover:bg-gray-100 hover:shadow-lg transition-all">
              <svg width="22" height="22" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                <path d="M20.52 3.449C18.24 1.245 15.24 0 12.045 0 5.463 0 .104 5.334.101 11.893c-.002 2.086.544 4.14 1.583 5.952L.057 24l6.32-1.65c1.765.952 3.738 1.455 5.748 1.456h.005c6.58 0 11.942-5.334 11.946-11.895.002-3.174-1.233-6.16-3.551-8.462z" fill="#25D366"/>
                <path d="M18.528 14.526c-.347-.174-2.052-1.011-2.37-1.127-.318-.116-.549-.174-.78.174-.231.348-.895 1.127-1.098 1.358-.202.231-.404.26-.751.087-.346-.174-1.464-.539-2.79-1.727-1.031-.925-1.727-2.067-1.929-2.415-.202-.348-.021-.536.152-.71.156-.156.347-.405.52-.607.173-.203.231-.348.347-.58.116-.231.058-.434-.029-.607-.087-.174-.78-1.881-1.069-2.576-.282-.676-.569-.584-.78-.595-.198-.01-.429-.011-.66-.011-.231 0-.607.087-.924.434-.318.347-1.213 1.186-1.213 2.893s1.242 3.355 1.415 3.586c.174.231 2.443 3.725 5.918 5.228 3.475 1.503 3.475 1.002 4.11 1.002.635 0 2.052-.839 2.34-1.649.29-.81.29-1.504.203-1.65-.087-.145-.318-.231-.665-.405z" fill="#FEFEFE"/>
              </svg>
              Get In Touch
            </a>
          </div>
